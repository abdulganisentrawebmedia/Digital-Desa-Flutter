class SKWaliHakimResponseDto {
  final SKWaliHakimDataDto data;

  SKWaliHakimResponseDto({required this.data});

  factory SKWaliHakimResponseDto.fromJson(Map<String, dynamic> json) {
    return SKWaliHakimResponseDto(
      data: SKWaliHakimDataDto.fromJson(json['data']),
    );
  }
}

class SKWaliHakimDataDto {
  ...
  factory SKWaliHakimDataDto.fromJson(Map<String, dynamic> json) {
    return SKWaliHakimDataDto(
