class SKDomisiliPerusahaanResponseDto {
  final SKDomisiliPerusahaanDataDto data;

  SKDomisiliPerusahaanResponseDto({required this.data});

  factory SKDomisiliPerusahaanResponseDto.fromJson(Map<String, dynamic> json) {
    return SKDomisiliPerusahaanResponseDto(
      data: SKDomisiliPerusahaanDataDto.fromJson(json['data']),
    );
  }
}

class SKDomisiliPerusahaanDataDto {
  ...
  factory SKDomisiliPerusahaanDataDto.fromJson(Map<String, dynamic> json) {
    return SKDomisiliPerusahaanDataDto(
