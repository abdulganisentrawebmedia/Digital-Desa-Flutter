class SKStatusPerkawinanResponseDto {
  final SKStatusPerkawinanDataDto data;

  SKStatusPerkawinanResponseDto({required this.data});

  factory SKStatusPerkawinanResponseDto.fromJson(Map<String, dynamic> json) {
    return SKStatusPerkawinanResponseDto(
      data: SKStatusPerkawinanDataDto.fromJson(json['data']),
    );
  }
}

class SKStatusPerkawinanDataDto {
  ...
  factory SKStatusPerkawinanDataDto.fromJson(Map<String, dynamic> json) {
    return SKStatusPerkawinanDataDto(
