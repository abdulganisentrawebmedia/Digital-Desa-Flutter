class SKResiKTPSementaraResponseDto {
  final SKResiKTPSementaraDataDto data;

  SKResiKTPSementaraResponseDto({required this.data});

  factory SKResiKTPSementaraResponseDto.fromJson(Map<String, dynamic> json) {
    return SKResiKTPSementaraResponseDto(
      data: SKResiKTPSementaraDataDto.fromJson(json['data']),
    );
  }
}

class SKResiKTPSementaraDataDto {
  ...
  factory SKResiKTPSementaraDataDto.fromJson(Map<String, dynamic> json) {
    return SKResiKTPSementaraDataDto(
