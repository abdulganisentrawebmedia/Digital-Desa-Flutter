class SPMKartuKeluargaResponseDto {
  final SPMKartuKeluargaDataDto data;

  SPMKartuKeluargaResponseDto({required this.data});

  factory SPMKartuKeluargaResponseDto.fromJson(Map<String, dynamic> json) {
    return SPMKartuKeluargaResponseDto(
      data: SPMKartuKeluargaDataDto.fromJson(json['data']),
    );
  }
}

class SPMKartuKeluargaDataDto {
  ...
  factory SPMKartuKeluargaDataDto.fromJson(Map<String, dynamic> json) {
    return SPMKartuKeluargaDataDto(
